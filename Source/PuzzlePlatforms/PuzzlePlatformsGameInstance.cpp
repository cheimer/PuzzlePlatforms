...
void UPuzzlePlatformsGameInstance::Init()
{
	...
	if(SessionInterface.IsValid())
	{
		...
		SessionInterface->OnFindSessionsCompleteDelegates.AddUObject(
			this, &UPuzzlePlatformsGameInstance::OnFindSessionComplete);
...
void UPuzzlePlatformsGameInstance::Host(FString ServerName)
{
	...
	if(SessionInterface.IsValid())
	{
		auto ExisingSession = SessionInterface->GetNamedSession(SESSION_NAME);
...
{
	if(!Success || !SessionSearch.IsValid() || !Menu) return;
...
void UPuzzlePlatformsGameInstance::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Cannot Connect String"));
	}
...
void UPuzzlePlatformsGameInstance::CreateSesssion()
{
	if(!SessionInterface.IsValid()) return;
...
{
	if(!SessionInterface.IsValid()) return;
	if(!SessionSearch.IsValid()) ReturnToMainMenu();
